...
public enum Region {
	...
	/**
	 * Check if the longitude in the Conterminous US is in the Western US or in
	 * the Central & Eastern US.
	 * 
	 * @param lon
	 *            the longitude.
	 * @return {@link #WUS} if the longitude is in the Western US, {@link #CEUS}
	 *         if the longitude is in the Central & Eastern US or {@link #COUS}
	 *         if the longitude is in both the Western US and the the Central &
	 *         Eastern US.
	 */
